...
![The sign-in page, with a box for your email address](images/sign-in.png)
...
![The form for a new game, with fields for the name, where you play, the day and the number of players](images/new-game.png)

...
![The Show the QR code line on the game page, opened to reveal a QR code for the same invite link](images/invite-qr.png)
...
![The join page: the game's details, boxes for a name and an email address, and who's already playing underneath](images/join.png)

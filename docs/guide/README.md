...
Make The Team runs the weekly kickabout so you don't have to.
...
waitlist takes the place and is told by email. You don't have to notice, and
you don't have to chase.

This guide walks through it in the order you'll meet it.

1. [Setting up a game](01-setting-up-a-game.md) — signing in and creating your
   weekly fixture.
...
7. [Your own fixtures](07-your-own-fixtures.md) — the signed-in view of what's
   coming up, and signing in faster next time.

Chapters 1, 2, 5 and 6 are for whoever organises the game. Chapters 3, 4 and 7
are for everybody, and are worth passing on to your squad.

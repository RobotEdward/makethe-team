...
<p style="margin:0 0 20px; font-size:15px; line-height:1.5; color:#8c491a; font-weight:700;">${escapeHtml(lead)}</p>
...
<p style="margin:16px 0 0; font-size:13px; line-height:1.5; color:#645c50;">${escapeHtml(caveat)}</p>
